...
RcppExport SEXP runvb(SEXP alt_sexp, SEXP n_sexp, SEXP x_sexp, SEXP settings_sexp) { 
  ...
  for (int it=0;it<max_its;it++){
	...
	// update q(g)
	g_prec[locus_index][sample_index]=random_effect_precision+pf;
	g_mean_prec[locus_index][sample_index]=regression_mean*random_effect_precision+mpf; 
	...
	while (new_local_bound<old_local_bound){
	  step *= .5; 
	  g_prec[locus_index][sample_index]=random_effect_precision+step*pf+(1.0-step)*old_prec_f;
	  g_mean_prec[locus_index][sample_index]=regression_mean*random_effect_precision+step*mpf+(1.0-step)*old_mean_prec_f;
	...
	prec_f[locus_index][sample_index]=g_prec[locus_index][sample_index]-random_effect_precision; 
	mean_prec_f[locus_index][sample_index]=g_mean_prec[locus_index][sample_index]-random_effect_precision*regression_mean; 
	...
	if (allow_flips){
	  ...
	  double flipOn = local_bound(-pure_reg_mean,g_prec[locus_index][sample_index], g_mean_prec[locus_index][sample_index], a[locus_index][sample_index], random_effect_precision, alt[locus_index][sample_index], n[locus_index][sample_index]); 
	  double flipOff = local_bound(pure_reg_mean,g_prec[locus_index][sample_index], g_mean_prec[locus_index][sample_index], a[locus_index][sample_index], random_effect_precision, alt[locus_index][sample_index], n[locus_index][sample_index]); 
    ...
    if (learn_rep)
      random_effect_precision=total_terms/expected_err; 
    ...
    if (trace) 
      cout << "it: " << it << " re_var: " << 1.0/random_effect_precision << " beta l2 " << beta_l2 << " mean l2 " << means_l2 << " lb: " << lb << endl; 
